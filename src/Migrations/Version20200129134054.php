 ...
 */
final class Version20200129134054 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE article ADD author_of_id INT NOT NULL');
        $this->addSql('ALTER TABLE article ADD CONSTRAINT FK_23A0E664C8583B1 FOREIGN KEY (author_of_id) REFERENCES user (id)');
        $this->addSql('CREATE INDEX IDX_23A0E664C8583B1 ON article (author_of_id)');
    }
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE article DROP FOREIGN KEY FK_23A0E664C8583B1');
        $this->addSql('DROP TABLE user');
        $this->addSql('DROP TABLE user_article');
        $this->addSql('DROP INDEX IDX_23A0E664C8583B1 ON article');
        $this->addSql('ALTER TABLE article DROP author_of_id');
